...
// ../../node_modules/.deno/hono@4.12.29/node_modules/hono/dist/utils/cookie.js
...
// ../../node_modules/.deno/hono@4.12.29/node_modules/hono/dist/client/fetch-result-please.js
...
async function fetchRP(fetchRes) {
  ...
  if (!_fetchRes.ok) {
    throw new DetailedError(`${_fetchRes.status} ${_fetchRes.statusText}`, {
      statusCode: _fetchRes == null ? void 0 : _fetchRes.status,
      detail: {
        data: _fetchRes == null ? void 0 : _fetchRes._data,
        statusText: _fetchRes == null ? void 0 : _fetchRes.statusText
      }
    });
  }
...
// ../../node_modules/.deno/hono@4.12.29/node_modules/hono/dist/client/utils.js
...
// ../../node_modules/.deno/hono@4.12.29/node_modules/hono/dist/client/client.js
...
var ClientRequestImpl = class {
  constructor(url, method, options) {
    ...
    __publicField(this, "buildSearchParams");
...
var hc = (baseUrl, options) => createProxy(function proxyCallback(opts) {
  var _a;
  const buildSearchParamsOption = (options == null ? void 0 : options.buildSearchParams) ?? buildSearchParams;
