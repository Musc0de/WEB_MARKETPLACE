    ...
    <div className='max-w-4xl mx-auto py-12 px-4'>
      ...
      <div className='bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center'>
        ...
        <Text className='text-gray-700 leading-relaxed max-w-2xl mx-auto'>
          StarSuperScare didirikan pada tahun 2026 dengan tujuan sederhana: menghilangkan kerumitan
          dalam berbelanja online. Berawal dari ide kecil di sebuah garasi, kami terus berinovasi
          untuk membangun sistem marketplace yang tangguh, terpercaya, dan disukai oleh jutaan
          pelanggan di seluruh penjuru negeri.
        </Text>
      </div>
    </div>
  );
