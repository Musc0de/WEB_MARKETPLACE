      ...
      <div className='space-y-8'>
        ...
        <div className='space-y-6 text-gray-700 leading-relaxed'>
          <section className='space-y-3'>
            ...
            <Text>
              Kami mengumpulkan informasi dari Anda ketika Anda mendaftar di situs kami, masuk ke
              akun Anda, melakukan pembelian, mengikuti kontes, atau ketika Anda keluar dari situs.
              Informasi yang dikumpulkan mencakup nama, alamat email, nomor telepon, dan kartu
              kredit.
            </Text>
          </section>
          ...
          <section className='space-y-3'>
            ...
            <Text>
              ...
              pengalaman Anda dan menanggapi kebutuhan individual Anda, menyediakan konten
              periklanan yang disesuaikan, meningkatkan situs web kami, dan meningkatkan layanan
              pelanggan kami.
            </Text>
          </section>
          ...
          <section className='space-y-3'>
            ...
            <Text>
              ...
              Anda. Kami menggunakan enkripsi mutakhir untuk melindungi informasi sensitif yang
          ...
          <section className='space-y-3'>
            ...
            <Text>
              ...
              memungkinkan situs untuk mengenali browser Anda dan menangkap serta mengingat
              informasi tertentu.
            </Text>
          </section>
          ...
          <section className='space-y-3'>
            ...
            <Text>
              Kami tidak menjual, memperdagangkan, atau mentransfer informasi pribadi Anda yang
              dapat diidentifikasi secara pribadi ke pihak luar. Ini tidak termasuk pihak ketiga
              tepercaya yang membantu kami beroperasi, melakukan bisnis, atau melayani Anda.
            </Text>
          </section>
