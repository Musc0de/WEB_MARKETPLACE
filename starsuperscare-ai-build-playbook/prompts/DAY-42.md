# Prompt Hari 42 — Support FAQ, tickets, messages, dan attachments

Tempel `00-MASTER-PROMPT.md` satu kali pada project instruction, kemudian tempel blok berikut.

~~~text
KERJAKAN DAY 42/50 — SUPPORT FAQ, TICKETS, MESSAGES, DAN ATTACHMENTS
...
- docs/14-ai-build-playbook/progress/DAY-41-REPORT.md (bila Day > 01 dan file tersedia)

SCOPE HARI INI, URUT SESUAI BLOK KERJA:
1. 08:00–10:00 — Implement public/account FAQ read model and support ticket create/list/detail with category, order link validation, priority/status, and ownership.
2. 10:15–12:15 — Implement ticket message thread and private attachment upload/download with MIME/size/authorization rules.
3. 13:15–15:15 — Bangun dashboard support UI dan admin queue/detail/reply/assign/status workflow dengan notifications/outbox.
4. 15:30–17:30 — Tulis IDOR, attachment, spam/rate-limit, closed-ticket, and notification tests.
...
2. File `docs/14-ai-build-playbook/progress/DAY-42-REPORT.md` mengikuti template laporan harian.
3. Laporan harus memuat: ringkasan, file berubah, keputusan, migration, env baru, command yang dijalankan beserta PASS/FAIL, acceptance evidence, security review, blocker, technical debt, dan handoff Day 43.
