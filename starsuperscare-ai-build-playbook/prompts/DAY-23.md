# Prompt Hari 23 — Product detail, variants, gallery, reviews, dan related products
...
- docs/03-storefront/PRODUCTS.md
- docs/14-ai-build-playbook/progress/DAY-22-REPORT.md (bila Day > 01 dan file tersedia)

SCOPE HARI INI, URUT SESUAI BLOK KERJA:
1. 08:00–10:00 — Bangun /products/{slug} loader dengan not-found/inactive states dan metadata dasar.
2. 10:15–12:15 — Bangun gallery, product summary, variant selector, effective price, stock, quantity limits, add-cart, buy-now, wishlist, dan shipping/digital indicator.
3. 13:15–15:15 — Bangun tabs/accordion description, benefits, composition, usage, warning, shipping, reviews, serta related products.
4. 15:30–17:30 — Tulis tests untuk variant URL/state, sold/stock display, quantity clamping, image alt, and out-of-stock behavior.
...
2. File `docs/14-ai-build-playbook/progress/DAY-23-REPORT.md` mengikuti template laporan harian.
3. Laporan harus memuat: ringkasan, file berubah, keputusan, migration, env baru, command yang dijalankan beserta PASS/FAIL, acceptance evidence, security review, blocker, technical debt, dan handoff Day 24.
