# Prompt Hari 08 — Implement catalog, pricing, inventory, dan review schema
...
- docs/06-database/SCHEMA.md
- docs/14-ai-build-playbook/progress/DAY-07-REPORT.md (bila Day > 01 dan file tersedia)

SCOPE HARI INI, URUT SESUAI BLOK KERJA:
1. 08:00–10:00 — Model brands, categories bertingkat, products, product-category mapping, product variants, status, type physical/digital, dan SEO fields.
2. 10:15–12:15 — Model images/assets metadata dan pricing history dengan integer rupiah, compare-at price, effective range, serta constraint non-negatif.
3. 13:15–15:15 — Model warehouses, inventory levels, reservations, movements ledger, purchase limit, dan concurrency/version field.
4. 15:30–17:30 — Model rating/review statistics dan product_sales_stats gross/refunded/net; buat migration, index, tests, dan seed sample.
...
2. File `docs/14-ai-build-playbook/progress/DAY-08-REPORT.md` mengikuti template laporan harian.
3. Laporan harus memuat: ringkasan, file berubah, keputusan, migration, env baru, command yang dijalankan beserta PASS/FAIL, acceptance evidence, security review, blocker, technical debt, dan handoff Day 09.
